...
import { getBookingData } from '../redux/Booking/thunk';
// components
...
export default function BookingPage() {
  ...
  const filteredUsers = applySortFilter(bookingList, getComparator(order, orderBy), filterName);
                    ...
                    return (
                      <TableRow hover key={id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        <TableCell padding="checkbox">
                          <Checkbox checked={selectedUser} onChange={(event) => handleClick(event, fee)} />
                        </TableCell>
                        ...
                        <TableCell align="left">{fDateTime(startTime)}</TableCell>

                        <TableCell align="left">{fDateTime(endTime)}</TableCell>
