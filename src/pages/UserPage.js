...
import { getUserData } from '../redux/Users/thunk';
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, name, avatar, kid, phone, gender, account } = row;
                    ...
                    return (
                      <TableRow hover key={id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell align="left">{kid?.length}</TableCell>
